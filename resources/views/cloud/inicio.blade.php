    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Rabbit Cloud</h1>
                <hr>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:your-email@your-domain.com">feedback@.com</a></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">
					La empresa RABBITCLOUD tiene como fin brindar servicios de administración informática de forma ágil, eficiente y segura a los clientes que adquieran nuestros productos garantizando, la calidad de estos y la tranquilidad de contar con el soporte y asistencia técnica para la implementación y manejo, que solo nuestra empresa proporciona.</p>
                    <h2 class="section-heading">VISION</h2>
                    <hr class="light">
                    <p class="text-faded">La empresa RABBITCLOUD se constituirá para el año como la empresa líder en administración informática en Guatemala brindando servicios de excelente calidad. </p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
              <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">Nuestra empresa nació con la idea de un particular conjunto de definiciones que se basa en la idea de innovar y presentar diferentes tipos de alternativas a la hora de manejar todas las situaciones cotidianas ,en las que se ve envuelta una persona promedio, a la hora de manejar tareas ,tan simples como es la seguridad y envió de archivos ,brindando innovadoras formas y ofreciendo servicios para facilitar este tipo de taras ,dándole la oportunidad de poder satisfacer ciertos ,problemas a cambio de cómodos precios.</p>
                    </div>
                    <div class="service-box">
